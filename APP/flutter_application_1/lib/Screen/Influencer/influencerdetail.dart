...
void _fetchInfluencerData() {
  ...
  influencerViewModel.fetchInfluencerData(widget.order.orderCartId, widget.order.influencerAdminId.toString());
  ...
  Widget build(BuildContext context) {
    return buildBaseScreen(
      ...
      body: DefaultTabController(
        length: 4, // Increase the length to 4 to accommodate the new tab
        child: Column(
          children: <Widget>[
            TabBar(
              tabs: [
                ...
                Tab(text: 'Status'),
                Tab(text: 'Images'), // New Images tab
              ],
            ),
            Expanded(
              child: TabBarView(
                children: [
                  ...
                  buildStatusInfo(),
                  buildImageInfo(), // New method to display images
                ],
              ),
            ),
          ],
      ...
      child: ListView(
        children: [
          ...
          ListTile(
            ...
            subtitle: Text('${widget.order.payAmount}'),
          ),
    ...
    child: GridView.builder(
      ...
      itemBuilder: (context, index) {
        return GestureDetector(
          onTap: () {
            _launchURL(imageUrls[index]); // Open image in the browser
          },
          child: Stack(
            children: [
              ClipRRect(
