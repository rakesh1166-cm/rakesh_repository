...
class Task {
  ...
  Task({
    this.id = 0, // Add id to the constructor
    this.adminId = 0,
  ...
  factory Task.fromJson(Map<String, dynamic> map) {
    try {
      int id = int.tryParse(map["id"].toString()) ?? 0; // Add parsing for id
