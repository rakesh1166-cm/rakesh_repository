...
import 'package:wizbrand/main.dart';
...
class _ProfileScreenState extends State<ProfileScreen> with NavigationMixin {
  ...
  Future<void> _checkLoginStatusAndFetchData() async {
    ...
    if (widget.userEmail.isNotEmpty && widget.userEmail != email) {
      ...
      await Provider.of<OrganizationViewModel>(context, listen: false).fetchProfiles(widget.userEmail);
    } else if (email != null && password != null) {
      setState(() {
        _isLoggedIn = true;
        _email = email;
      });
      await Provider.of<OrganizationViewModel>(context, listen: false).fetchProfiles(email);
    }
...
Future<void> _pickImage() async {
  ...
  if (pickedImage != null) {
    ...
    await Provider.of<OrganizationViewModel>(context, listen: false)
 ...
 Future<Map<String, String?>> _getCredentials() async {
  ...
  Widget build(BuildContext context) {
    ...
    final influencerViewModel = Provider.of<OrganizationViewModel>(context);
    final fetchprofile = influencerViewModel.fetchprofile;
        print("fetchprofile is there");
        print(fetchprofile);
...
class _UpdatePasswordFormState extends State<UpdatePasswordForm> {
  ...
  // For Country, State, and City Dropdowns
  ...
  Future<void> _updatePassword() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (email != null) {
        final influencerViewModel = Provider.of<OrganizationViewModel>(context, listen: false);
        ...
        child: Column(
          ...
          children: [
              ...
              child: DropdownButton<String>(
                ...
                onChanged: (newValue) {
                  setState(() {
                    ...
                    _selectedCountryId = countryViewModel.countries
                        .firstWhere((country) => country.country_name == newValue)
                        .country_id;
                  ...
                  Provider.of<CountryViewModel>(context, listen: false)
                      .fetchStates(_selectedCountryId);
                },
                items: ['All', ...countryViewModel.countries.map((country) => country.country_name)]
                    .map((countryName) {
              ...
              child: DropdownButton<String>(
                ...
                onChanged: (newValue) {
                  setState(() {
                    ...
                    _selectedStateId = countryViewModel.states
                        .firstWhere((state) => state.state_name == newValue)
                        .state_id
                        .toString();
                    _selectedCityId = 'All';
                    _selectedCityName = 'Select City';
                  ...
                  Provider.of<CountryViewModel>(context, listen: false)
                      .fetchCities(_selectedStateId);
                },
                items: ['Select State', ...countryViewModel.states.map((state) => state.state_name)]
                    .map((stateName) {
                  return DropdownMenuItem<String>(
                    value: stateName,
              ...
              child: DropdownButton<String>(
                ...
                onChanged: (newValue) {
                  setState(() {
                    ...
                    _selectedCityId = countryViewModel.cities
                        .firstWhere((city) => city.city_name == newValue)
                        .city_id
                        .toString();
                  });
                },
                items: ['Select City', ...countryViewModel.cities.map((city) => city.city_name)]
                    .map((cityName) {
                  return DropdownMenuItem<String>(
                    value: cityName,
                    child: Text(cityName),
            ...
            TextFormField(
              ...
              onChanged: (value) {
                print("Confirm Password value: $value");
                setState(() {});
              },
              decoration: InputDecoration(
