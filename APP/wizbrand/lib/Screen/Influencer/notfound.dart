          ...
          children: [
            ...
            if (message == 'No orders found') // add this condition
              Column(
                children: [
                  Text(
                    ...
                    style: TextStyle(
                     ...
                     Text(
                    'We couldnt find any orders in your my order. Please try adjusting your filters or check back later',
                    style: TextStyle(
                      color: Colors.grey,
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
               ...
               Text(
                    'We couldnt find any task in your my influencer work detail. Please try adjusting your filters or check back later',
                    style: TextStyle(
                      color: Colors.grey,
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
