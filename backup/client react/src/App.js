...
import FaqGeneration from "./components/FaqGeneration";
    ...
    <Provider store={store}>
      <Router>
        <Routes>
          ...
          <Route path="/langchain/recipe-recommendation" element={<RecipeRecommendation />} />
          <Route path="/langchain/faq-generation" element={<FaqGeneration />} />
          <Route path="/langchain/job-recommendation" element={<JobRecommendation />} />
          <Route path="/langchain/movie-recommendation" element={<MovieRecommendation />} />
          <Route path="/langchain/task-scheduling" element={<TaskScheduling/>} />
          <Route path="/langchain/suggest-places" element={<SuggestPlaces/>} />
          <Route path="/codegenerate/auto-codegeneration" element={<CodeGenerate/>} />
